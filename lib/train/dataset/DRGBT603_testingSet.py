...
class DRGBT603_testingSet(BaseVideoDataset):
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None,data_fraction=None, attr=None):
        ...
        super().__init__('DRGBT603_testingSet', root, image_loader)
    ...
    def get_sequence_info(self, seq_id):
        ...
        modal_up = modal_up.clone().byte()
        modal_down = modal_down.clone().byte()
