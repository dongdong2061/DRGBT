...
from lib.train.dataset import VisEvent, LasHeR, DepthTrack,DRGBT603_trainingSet,DRGBT603_testingSet
...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        assert name in ["LASOT", "GOT10K_vottrain", "GOT10K_votval", "GOT10K_train_full", "GOT10K_official_val", "COCO17", "VID", "TRACKINGNET",
                        "DepthTrack_train", "DepthTrack_val", "LasHeR_all", "LasHeR_train", "LasHeR_val", "VisEvent","RGBT210","DRGBT603","DRGBT603_test"]
        ...
        if name == "DRGBT603":
            datasets.append(DRGBT603_trainingSet(settings.env.drgbt603_dir))
        if name == "DRGBT603_test":
            datasets.append(DRGBT603_testingSet(settings.env.drgbt603_dir))
        if name == "VisEvent":
            datasets.append(VisEvent(settings.env.visevent_dir, dtype='rgbrgb', split='train'))
